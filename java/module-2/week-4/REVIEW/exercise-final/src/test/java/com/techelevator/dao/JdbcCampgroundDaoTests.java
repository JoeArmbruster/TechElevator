...
public class    JdbcCampgroundDaoTests extends BaseDaoTests {
    ...
    @Test
    public void getCampgroundById_returns_correct_campground_for_id() {

        Campground campground = jdbcCampgroundDao.getCampgroundById(1);
        Assert.assertNotNull("getCampgroundById(1) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(1) returned wrong or partial data",
                CAMPGROUND_1, campground);

        campground = jdbcCampgroundDao.getCampgroundById(2);
        Assert.assertNotNull("getCampgroundById(2) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(2) returned wrong or partial data",
                CAMPGROUND_2, campground);

        campground = jdbcCampgroundDao.getCampgroundById(3);
        Assert.assertNotNull("getCampgroundById(3) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(3) returned wrong or partial data",
                CAMPGROUND_3, campground);

        campground = jdbcCampgroundDao.getCampgroundById(4);
        Assert.assertNotNull("getCampgroundById(4) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(4) returned wrong or partial data",
                CAMPGROUND_4, campground);

        campground = jdbcCampgroundDao.getCampgroundById(5);
        Assert.assertNotNull("getCampgroundById(5) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(5) returned wrong or partial data",
                CAMPGROUND_5, campground);

        campground = jdbcCampgroundDao.getCampgroundById(6);
        Assert.assertNotNull("getCampgroundById(6) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(6) returned wrong or partial data",
                CAMPGROUND_6, campground);

        campground = jdbcCampgroundDao.getCampgroundById(7);
        Assert.assertNotNull("getCampgroundById(7) returned null", campground);
        assertCampgroundsMatch("getCampgroundById(7) returned wrong or partial data",
                CAMPGROUND_7, campground);

        // Campground 8 does not exist
        campground = jdbcCampgroundDao.getCampgroundById(8);
        Assert.assertNull("getCampgroundById(8) does not exist and should be null", campground);
    }
