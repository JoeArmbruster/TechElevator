...
/**
 * Write a function called makeHappy that takes an array and prepends
 * "Happy " to the beginning of all words and returns them as a new array.
 * 
 * Use the 'map' function.
 * 
 * @param {string[]} array the array of words to modify 
 * @returns {string[]} the new array with 'Happy ' prepended to each word
 */
...
/**
 * Write a function called getFullAddressesOfProperties that takes an array of 
 * Javascript objects. Each object contains the following keys:
 *     * streetNumber
 *     * streetName
 *     * streetType
 *     * city
 ...
 * 
 * @param {Object[]} properties an array of objects containing property details 
