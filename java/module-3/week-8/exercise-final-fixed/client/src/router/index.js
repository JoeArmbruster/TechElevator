...
const routes = [
    ...
    // Note the parameter here (hotelId) needs to match 
    // the parameter expected in ReservationAddView, line 117.
    // THIS SOLUTION HAS BEEN CHANGED BELOW, :id to :hotelId
    {
      path: '/hotel/:hotelId/newreservation',
